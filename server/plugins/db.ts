...
import { pillars, topics, resources, progress } from '../db/schema'
...
export default defineNitroPlugin(async () => {
  ...
  console.log('[db] Seeding database on first boot...')

  const seedData = await import('../db/seed-data').then(m => m.default)
